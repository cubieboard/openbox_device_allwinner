...
public class Memory extends SettingsPreferenceFragment {
    ...
    private static final String KEY_MUTIL_MEDIA_CATEGORY = "mutil_media_category" ;
    ...
    public void onCreate(Bundle icicle) {
        ...
        // media scan
        mMutilMediaCategory = (PreferenceCategory) findPreference(KEY_MUTIL_MEDIA_CATEGORY);
        ...
        mMutilMediaCategory.addPreference(mMediaScanSDToggle);
        mMutilMediaCategory.addPreference(mMediaScanUSBToggle);
        
        mEnableBluRay = new CheckBoxPreference(this.getActivity());
        mEnableBluRay.setTitle(R.string.enable_blu_ray_directory_play_title);
        mEnableBluRay.setSummary(R.string.enable_blu_ray_directory_play_summary);
        mMutilMediaCategory.addPreference(mEnableBluRay);
        ...
        boolean enableBluRay = Settings.System.getInt(getActivity().getContentResolver(), 
                Settings.System.BD_FOLDER_PLAY_MODE, 0) != 0 ? true : false;
        mEnableBluRay.setChecked(enableBluRay);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (mEnableBluRay.equals(preference)){
        	boolean enableBluRay = mEnableBluRay.isChecked();
        	Settings.System.putInt(getActivity().getContentResolver(), 
                    Settings.System.BD_FOLDER_PLAY_MODE, enableBluRay ? 1 : 0);
        }
        return false;
    }

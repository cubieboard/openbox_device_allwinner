...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    private Preference mAudioOutput;
...
/*
    private static String mAuModeEntryValue[] = {
        Integer.toString(AudioManager.AUDIO_OUT_CHANNEL_CODEC),
        Integer.toString(AudioManager.AUDIO_OUT_CHANNEL_HDMI),
        Integer.toString(AudioManager.AUDIO_OUT_CHANNEL_SPDIF)};
    private static String mAuModeEntries[] = {
    	AudioManager.AUDIO_OUT_CHANNEL_NAME_CODEC,
    	AudioManager.AUDIO_OUT_CHANNEL_NAME_HDMI,
    	AudioManager.AUDIO_OUT_CHANNEL_NAME_SPDIF,};
*/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Tvd feature
        /*
        mAudioOutput = (ListPreference)findPreference(KEY_AUDIO_OUTPUT_MODE);
        mAudioOutput.setEntries(mAuModeEntries);
        mAudioOutput.setEntryValues(mAuModeEntryValue);
        mAudioOutput.setValue(Integer.toString(mAudioManager.getAudioOutMode()));
        mAudioOutput.setOnPreferenceChangeListener(this);*/

        mAudioOutput = findPreference(KEY_AUDIO_OUTPUT_MODE);
		mAudioSelector = new AudioChannelsSelect(getActivity());
		Log.d(TAG,"click preference for audio output");
    ...
    public void onResume() {
		...
		mAudioSelector.registerUSBAudioReceiver();
    }

    @Override
    public void onPause() {
        super.onPause();
        mAudioSelector.dismissDialog();
        getActivity().unregisterReceiver(mReceiver);

		mAudioSelector.unregisterUSBAudioReceiver();
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mDtmfTone) {
            ...
            return false;
        } else if (preference == mAudioOutput) {
...
//        	Log.d(TAG,"preference change for audio output mode");
//			Log.d("chen","#######channels: " + mAudioOutput.getEntries());
//        	HashSet<String> values = (HashSet<String>) objValue;
...
//			}
//			Log.d(TAG,"#########values: " + ls);
//			mAudioManager.setAudioDeviceActive(ls, AudioManager.AUDIO_OUTPUT_ACTIVE);
        }

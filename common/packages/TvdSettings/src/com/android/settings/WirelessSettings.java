...
public class WirelessSettings extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!isWimaxEnabled) {
            ...
            if (removeApMode &&
            		(toggleable == null || 
            		!toggleable.contains(Settings.System.RADIO_WIMAX ) && 
            		isWimaxEnabled )) {
                Preference ps = (Preference) findPreference(KEY_WIMAX_SETTINGS);
        ...
        if (removeApMode && 
        		(toggleable == null || !toggleable.contains(Settings.System.RADIO_WIFI))) {
        ...
        if (removeApMode && 
        		(toggleable == null || !toggleable.contains(Settings.System.RADIO_NFC))) {
        ...
        if(chipType.equals(ProductConfig.CHIP_TYPE_A10S)){
        	//elite feature
        	Preference ethernetSettings = findPreference(KEY_ETHERNET_SETTINGS);
        	if(ethernetSettings != null)
        		getPreferenceScreen().removePreference(ethernetSettings);
        }
